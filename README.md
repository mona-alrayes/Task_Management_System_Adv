...
- **Testing** : all feature testing is applied in sqlite in memory please check file **phpnit.xml** then uncomment these two lines if they are commented **<env name="DB_CONNECTION" value="sqlite"/>**
